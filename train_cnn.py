...
# Load datasets
train_dataset = datasets.ImageFolder(root=r'D:\Surgical AI assitant\brain\dataset\train', transform=train_transform)
val_dataset = datasets.ImageFolder(root=r'D:\Surgical AI assitant\brain\dataset\validation', transform=val_test_transform)
test_dataset = datasets.ImageFolder(root=r'D:\Surgical AI assitant\brain\dataset\test', transform=val_test_transform)
